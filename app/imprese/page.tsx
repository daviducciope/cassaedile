...
export default function ImpresePage() {
  return (
    <AudiencePage
      ...
      description="Un percorso unico per iscrizione, regolarita, cantieri, versamenti, certificati e assistenza."
      highlights={[
        "Avvia iscrizione o aggiorna dati aziendali",
        "Consulta documenti su DURC e regolarita contributiva",
